        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            <h3 className="text-2xl font-semibold mb-4">
              Passionate React Developer with 2+ Years Experience
            </h3>
            <p className="text-muted-foreground mb-6">
              I'm a full-stack developer specializing in React and React Native
              development. With a strong foundation in JavaScript and
              TypeScript, I build performant, accessible, and user-friendly
              applications that solve real-world problems.
            </p>
            <p className="text-muted-foreground mb-6">
              My journey in web development began during college, where I
              discovered my passion for creating interactive user interfaces.
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    MyanCare Telemedicine (2025 - Present)
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-medium">
                    Diploma in Network Communications
                  </h4>
                  <p className="text-sm text-muted-foreground">
                    KMD (2018 - 2019)
                  </p>
